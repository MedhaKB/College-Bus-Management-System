          ...
          <form method="post" action="methods/studentadd.php">
            <div class="row g-3 w-80">
              ...
              <!-- <div class="col-sm-12 form-item">
                ...
                <input type="text" class="contactus form-control" id="inputstop" value="<?php echo "$address"; ?>"
                  name="stopname" required>
              </div> -->
              <!-- <div class="col-sm-12 form-item">
                <label for="inputbno" class="form-label">Bus no</label>
                <input type="number" class="contactus form-control" id="inputbno" value="<?php echo "$busno"; ?>"
                  name="busnumber" required>
              </div> -->
              <div class="col-sm-12">
                <button class="send btn btn-warning" name="reg">Update</button><br></br>
              </div>
            </div>
          </form>
        </div>
