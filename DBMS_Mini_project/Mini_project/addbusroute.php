          ...
          <form method="post" action="methods/routeadd.php">
            <div class="row g-3 w-80">
              <div class="col-sm-12 form-item">
                ...
                <input type="text" class="contactus form-control" id="inputrouteno" placeholder="Route No"  name="routeno" required>
              </div>
              <div class="col-sm-12 form-item">
                <label for="inputstartloc" class="form-label">Starting Point</label>
                <input type="text" class="textarea form-control" id= "inputcapacity" placeholder="Start Point" name="startloc" required>
              </div>
              <div class="col-sm-12 form-item">
                <label for="inputendloc" class="form-label">End Location</label>
                <input type="text" class="contactus form-control" id="inputendloc" placeholder="End Point" name="endloc" required>
              </div> 
    <!------------ intermediate stops ------------->
              <div class="locations d-block">
                <div class="loc col-sm-12 form-item">
                  <label for="pickuppoint[]" class="form-label">Pick-up point</label>
                  <input type="text" class="contactus form-control" id="pickuppoint" placeholder="pickup point 1" name="pickuppoint[]">
                </div>
              </div>   
