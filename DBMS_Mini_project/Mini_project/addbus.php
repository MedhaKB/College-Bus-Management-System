...
<!-- -----------------Body------------------------>
    <div class="wrapper d-flex align-items-stretch" >
        ...
        <h2 class="mb-4 form-heading">ADD BUS</h2>
        <hr style="height:2px;border-width:0;color:gray;background-color:gray;width:100%;">
            <div class=" col-md-6">
                <div class="address">
                    <form method="post" action="methods/busadd.php">
                        <div class="row g-3 w-80">
                            <div class="col-sm-12 form-item">
                                <label for="inputbusno" class="form-label">Bus NO</label>
                                <input type="text" class="contactus form-control" id="inputbusno" placeholder="Bus NO"  name="busno" required>
                            </div>
                            <div class="col-sm-12 form-item">
                                <label for="inputcapacity" class="form-label">Capacity</label>
                                <input type="number" class="textarea form-control" id= "inputcapacity" placeholder="Capacity" name="cap" required>
                            </div>
                            <div class="col-sm-12 form-item">
                                <label for="inputrno" class="form-label">Route no</label>
                                <input type="number" class="contactus form-control" id="inputrno" placeholder="Route number" name="rno" required>
                            </div>    
                            <div class="col-sm-12 form-item">
                                <label for="inputcOid" class="form-label">Coordinator ID</label>
                                <input type="number" class="contactus form-control" id="inputcoid" placeholder="Coordinator ID" name="coid" required>
                            </div>    
                            <div class="col-sm-12 form-item">
                                <label for="inputdrid" class="form-label">Driver ID</label>
                                <input type="number" class="contactus form-control" id="inputdrid" placeholder="Driver ID" name="drid" required>
                            </div>    
                            <div class="col-sm-12">
