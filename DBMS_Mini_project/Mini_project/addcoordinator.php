    ...
    <div class="wrapper d-flex align-items-stretch" >
        ...
        <div id="content" class=" container-sm col-md-6 pt-4">
            ...
            <div class=" col-md-8 position-relative start-0">
                    <div class="address">
                        <form method="post" action="methods/coordadd.php">
                            <div class="row g-3 ">
                                <div class="col-sm-12 form-item">
                                    <label for="inputcoid" class="form-label pe-5">Coordinator ID</label>
                                    <input type="text" class="contactus form-control" id="inputcoid" placeholder="Coordinator ID"  name="coid" required>
                                </div>
                                <div class="col-sm-12 form-item">
                                    <label for="inputconame" class="form-label">Coordinator Name</label>
                                    <input type="text" class="contactus form-control" id= "inputconame" placeholder="Coordiantor Name" name="coname" required>
                                </div>
                                <div class="col-sm-12 form-item">
                                    <label for="inputcocontact" class="form-label">Coordiantor Contact</label>
                                    <input type="number" class="contactus form-control" id="inputcocontact" placeholder="Contact" name="cocontact" required>
                                </div>    
                                <div class="col-sm-12">
