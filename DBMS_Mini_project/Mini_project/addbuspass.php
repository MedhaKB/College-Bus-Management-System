  ...
  <div class="wrapper d-flex align-items-stretch" >
    ...
    <div id="content" class="container-sm col-md-6 pt-4">
      ...
      <div class=" col-md-6 position-relative start-0">
        <div class="address">
          <form method="post" action="methods/buspassadd.php">
            <div class="row g-3 w-80">
              ...
              <div class="col-sm-12 form-item">
                ...
                <input type="text" class="contactus form-control" id="inputisuuedate" placeholder="Issued date" name="isdate">
              </div>
              <div class="col-sm-12 form-item">
                <label for="inputvaliddate" class="form-label">Valid till</label>
                <input type="text" class="contactus form-control" id="inputvaliddate" placeholder="Valid till" name="valdate">
              </div>
              <div class="col-sm-12 form-item">
                <label for="inputstatus" class="form-label">Fee status</label>
                <input type="text" class="contactus form-control" id="inputstatus" placeholder="Fee status" name="fstatus">
              </div>         
              <div class="col-sm-12 buttons">
                <button class="send" name='addpass'>Add</button><br>
                <a href="updatebuses.php"><button  class="send">Update</button></a><br>
